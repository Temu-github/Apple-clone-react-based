                ...
                <div className="container">
                    <Navbar className="w-100" collapseOnSelect expand="lg" variant="dark">
                        ...
                        <Navbar.Collapse id="responsive-navbar-nav"  >
                            <br />
                            <Nav className=" w-100 nav-fill justify-content-start flex-grow-1 pe-3">
                                ...
                                <ul className="navbar-nav nav-justified w-100 nav-fill">
                                    ...
                                    <Nav.Link href="/search"><img src={search_icon} alt="search" display="none" /></Nav.Link>
                        ...
                        <Nav.Link href="/cart"><img src={cart_icon} alt="add-cart" />
                        </Nav.Link>
                        {/* <Navbar.Brand href="/"><img src={cart_icon} alt="add-cart" /></Navbar.Brand> */}
                    </Navbar>
